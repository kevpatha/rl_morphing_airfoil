...
class MFC_aileron_Env(gym.Env):
    ...
    def __init__(self, start_volt = 50, goal_position=0, steps_per_ep = 200):
        ...
        self.act_mean = 50
        self.act_std = 26.8
        self.pos_mean = 755.526 #meausered by flex
        self.pos_std = 76.0765 #measured by flex
        self.laz_mean = 497.5
        self.laz_std = 226
    ...
    def step(self, action):
        ...
        #new_pos = self.flex_to_laz(self.laf)
        new_pos = self.normalize_laz(laz_obs)
